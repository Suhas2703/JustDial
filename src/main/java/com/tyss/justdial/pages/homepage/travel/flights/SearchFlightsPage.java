...
public class SearchFlightsPage extends BasePage {
	...
	public void clickOnRoundTripIcon() {
		mobileActionUtil.clickOnMobileElement(roundTripTab, "Round Trip Icon");
	}
	...
	/**
	 * @author Harsha K.B
	 * @description Method to Select the Departure Date Date should be in format
	 *              yyyy-mm-dd Month name is converted into TitleCase as xpath
	 *              element requirement
	 */
	public void selectDepartureDate(String date) throws InterruptedException {
		...
		mobileActionUtil.tapOnElement(driver.findElement(By.xpath("//android.widget.TextView[@text='" + mnthyear
				+ "']/following-sibling::android.view.ViewGroup[@resource-id='com.justdial.search:id/calendar_grid']/descendant::android.widget.TextView[@text="
				+ day + "]/ancestor::android.widget.FrameLayout[1]")));

	}

	/**
	 * @author Harsha K.B
	 * @description This method takes date as a String and returns an array of
	 *              String splitting Year,Month & Day Date to be sent in the format
	 *              2020-12-03 i.e. Year-Month-Date
	 * 
	 */
	...
	/**
	 * @author Harsha K.B
	 * @description This method will verify if Flights are sorted by Prices in
	 *              Ascending order
	 * 
	 */
	public void validateIfFlightsAreSortedByRateAscending() throws ParseException {
		List<WebElement> lstflightlist = driver.findElements(
				By.xpath("//android.widget.ListView[@resource-id='sortResult']/android.view.View/android.view.View"));
	...
	/**
	 * @author Harsha K.B
	 * @description This method will verify if Flights are sorted by Duration in
	 *              Ascending order
	 * 
	 */
	...
	/**
	 * @author Harsha K.B
	 * @description This method will verify if Flights are sorted by FlightTime in
	 *              Ascending order
	 * 
	 */
	...
	/**
	 * @author Harsha K.B
	 * @description This method will verify if Flight are sorted by price in
	 *              Ascending order in round trip_dep
	 * 
	 */

	public void validateIfFlightsAreSortedByRateAscending_RoundTrip_Dep() throws ParseException {
		List<WebElement> lstflightlist = driver.findElements(
				By.xpath("//android.view.View[@resource-id='sortResultL']/android.view.View/android.view.View"));

		ArrayList<Integer> al1 = new ArrayList<>();
		for (WebElement we : lstflightlist) {
			String[] strvals = we.getText().split(" ");
			String[] filvals = filterValuesInArray_RoundTrip(strvals);

			al1.add(NumberFormat.getNumberInstance(Locale.UK).parse(filvals[1]).intValue());
		...
		if (al1.equals(al2))
			System.out.println("Flight prices are sorted in Ascending order");
		else
			System.out.println("Flight prices are not sorted in Ascending order");
	 ...
	 * @author Harsha K.B
	 * @description This method will verify if Flight are sorted by price in
	 *              Descending order in round trip_dep
	 * 
	 */

	public void validateIfFlightsAreSortedByRateDescending_RoundTrip_Dep() throws ParseException {
		List<WebElement> lstflightlist = driver.findElements(
				By.xpath("//android.view.View[@resource-id='sortResultL']/android.view.View/android.view.View"));
		...
		if (al1.equals(al2))
			System.out.println("Flight prices are sorted in Descending order");
		else
			System.out.println("Flight prices are not sorted in Descending order");
	...
	public void validateIfFlightsAreSortedByTimeAscending_RoundTrip_Dep() throws ParseException {
		
		List<WebElement> lstflightlist = driver.findElements(By.xpath("//android.view.View[@resource-id=\"sortResultL\"]/android.view.View/android.view.View"));
		...
		for (WebElement we : lstflightlist) {
		  ...
		  ArrayList<LocalTime> al2 = new ArrayList(al1); Collections.sort(al1);
		  
		  if (al1.equals(al2))
		  System.out.println("Flight Timings are sorted in Ascending order"); else
		  System.out.println("Flight Timings are not sorted in Ascending order");
		  
		  System.out.println("Expected"); System.out.println(al1);
		  System.out.println("Actual"); System.out.println(al2);
	...
	public void validateIfFlightsAreSortedByTimeDescending_RoundTrip_Dep() throws ParseException {
	 ...
	 * @author Harsha K.B
	 * @description This method will verify if Flight are sorted by price in
	 *              Descending order in round trip_return
	 * 
	 */

	public void validateIfFlightsAreSortedByRateAscending_RoundTrip_Return() throws ParseException {
		List<WebElement> lstflightlist = driver.findElements(By.xpath("//android.view.View[@resource-id='sortResultR']/android.view.View/android.view.View"));
	...
	public void validateIfFlightsAreSortedByRateDescending_RoundTrip_Return() throws ParseException {
		List<WebElement> lstflightlist = driver.findElements(By.xpath("//android.view.View[@resource-id='sortResultR']/android.view.View/android.view.View"));
	 ...
	 * @author Harsha K.B
	 * @description This method will verify if Flights are sorted by FlightTime in
	 *              Ascending order in round trip_return
	 * 
	 */

	public void validateIfFlightsAreSortedByTimeAscending_RoundTrip_Return() throws ParseException {
		...
		for (WebElement we : lstflightlist) {
		  ...
		  if (al1.equals(al2))
		  System.out.println("Return Flight Timings are sorted in Ascending order"); else
		  System.out.println("Return Flight Timings are not sorted in Ascending order");
	...
	public void validateIfFlightsAreSortedByTimeDescending_RoundTrip_Return() throws ParseException {
		...
		if (al1.equals(al2))
			System.out.println("Return Flight Timings are sorted in Descending order");
		else
			System.out.println("Return Flight Timings are not sorted in Descending order");
	...
	/**
	 * @author Harsha K.B
	 * @description This method will filter the values required for processing the
	 *              result to check if prices are sorted,durations are sorted or
	 *              Times are sorted
	 * 
	 */
	...
	public String[] filterValuesInArray(String[] flightdetails) {
		...
		// we have to fetch 4 values before | symbol in the text available in the
		// results of sorting
	...
	public String[] filterValuesInArray_RoundTrip(String[] flightdetails) {
		String filteredvalues[] = new String[2];
